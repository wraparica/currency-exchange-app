    ...
    <form onSubmit={handleSubmit} className="flex items-end gap-2 sm:gap-3">
      <div className="flex shrink-0 flex-col gap-1">
        ...
        <select
          ...
          className="rounded-md border border-[#253241] bg-[#101820] px-3 py-3 font-mono text-sm text-slate-100 outline-none focus:border-amber-400/60"
        >
          {
      ...
      <input
        ...
        aria-label="Amount"
        className="min-w-0 flex-1 rounded-md border border-[#253241] bg-[#101820] px-4 py-3
                   font-sans text-sm text-slate-100 placeholder:text-slate-500
      ...
      <button
        ...
        className="shrink-0 rounded-md border border-amber-400/40 bg-amber-400/10 px-4 py-3
                   font-mono text-xs uppercase tracking-widest text-amber-400
                   ...
                   disabled:hover:bg-amber-400/10 sm:px-5"
      >
